...
export const BeautySalonCard = ({ address, city, schedule, title, image, status }: recommendBeautySalon) => {
    return (
        <div className="grid bg-white rounded-[10px] w-[190px] h-[210px]">
            <div className="h-[120px] relative">
                <Image src={image.src} className='rounded-[10px]' loading='lazy' fill objectFit='cover' alt="selection image" />
